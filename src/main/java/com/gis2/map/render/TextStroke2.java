...
public class TextStroke2 implements Stroke {
	private String text;
	private Font font;
	...
	public TextStroke2( String text, Font font ) {
		this( text, font, true, false );
	}

	public TextStroke2( String text, Font font, boolean stretchToFit, boolean repeat ) {
		this.text = text;
		this.font = font;
			...
			case PathIterator.SEG_LINETO:
				...
				if ( distance >= next ) {
					...
					while ( currentChar < length && distance >= next ) {
                        ...
                        //nextAdvance = currentChar < length-1 ? glyphVector.getGlyphMetrics(currentChar+1).getAdvance() * 1.0f : 0;
