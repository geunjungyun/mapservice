 ...
 * generated in the com.gis.protocol.freegis3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _PixelPerMeter_QNAME = new QName("", "pixelPerMeter");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gis.protocol.freegis3
     * 
     */
    ...
    /**
     * Create an instance of {@link RasterStyle }
     * 
     */
    public RasterStyle createRasterStyle() {
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "pixelPerMeter")
    public JAXBElement<Integer> createPixelPerMeter(Integer value) {
        return new JAXBElement<Integer>(_PixelPerMeter_QNAME, Integer.class, null, value);
    }
