...
//import com.util.thread2.Listener;
...
public class ThreadQueue {
    ...
    private synchronized void setRunningThreads(int runningThreads) {
    	//System.out.println("setRunningThreads("+runningThreads+")");
        this.runningThreads = runningThreads;
        if (runningThreads == 0 && queuedRunnables.size()==0) { 
    ...
    public void adds(Vector<Runnable> runs) {
    	
    	for(int i=0; i<runs.size(); i++){
    		
    		final Runnable runnable = runs.get(i);
