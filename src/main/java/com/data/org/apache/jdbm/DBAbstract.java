...
public abstract class DBAbstract implements DB {
    ...
    private static class ShutdownCloseThread extends Thread{
        ...
        ShutdownCloseThread(DBAbstract db){
            super("JDBM shutdown");
            this.dbToClose = db;
            //System.out.println("add JDBM shutdown");
        }

        public void run(){
        	
        	//System.out.println("shutdown commit and close");
            if(dbToClose!=null && !dbToClose.isClosed()){
            	...
            	//System.out.println("shutdown dbtoClose is null or close");
            }
        }
